...
const AboutPage = () => {
  ...
  return (
    <>
      <SEOHead 
        title="Hakkımda - Aydın Kocatürk"
        description="Merhaba, ben Aydın Kocatürk! Kişisel gelişim, girişimcilik ve yaşam deneyimlerimi paylaştığım Zirve Hikayem blog platformunun kurucusu. Her deneyim bir hikaye, her hikaye bir ders."
        keywords="aydın kocatürk, hakkımda, zirve hikayem, kişisel gelişim uzmanı, girişimci, motivasyon konuşmacısı, blog yazarı"
        url="/about"
        type="profile"
